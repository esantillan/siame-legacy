    ...
    $('#' + TABLA_ID).dataTable(
            {
                ...
                "ajax": {
                    "method": "post",
                    "url": BASE_URL + 'departamento/listar_ajax'
                },
                "columns": [{"data": "nombre"},{"data": "provincia"},{"data": "provincia_id"}, {"data": "fecha_alta"}, {"data": "operador_alta"}, {"data": "fecha_modificacion"}, {"data": "operador_modificacion"}, {"data": "baja"}, {"data": "acciones"}],
                "columnDefs": [

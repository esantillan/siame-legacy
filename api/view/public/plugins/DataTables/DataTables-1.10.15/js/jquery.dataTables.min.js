...
d[c]=e,"o"===b[1]&&Y(a[e])});a._hungarianMap=d}function J(a,b,c){a._hungarianMap||Y(a);var d;h.each(b,function(e){d=a._hungarianMap[e];if(d!==k&&(c||b[d]===k))"o"===d.charAt(0)?(b[d]||(b[d]={}),h.extend(!0,b[d],b[e]),J(a[d],b[d],c)):b[d]=b[e]})}function Fa(a){var b=m.defaults.oLanguage,c=a.sZeroRecords;!a.sEmptyTable&&(c&&"NingÃºn dato disponible en esta tabla"===b.sEmptyTable)&&F(a,a,"sZeroRecords","sEmptyTable");!a.sLoadingRecords&&(c&&"<span class='table_loader'><i id='table_loader' class='fa fa-spinner fa-spin fa-3x fa-fw'></i><br> Cargando...</span>"===b.sLoadingRecords)&&F(a,a,"sZeroRecords","sLoadingRecords");
...
sSortDescending:": Activar para ordenar la columna de manera descendente"},oPaginate:{sFirst:"Primero",sLast:"Ãšltimo",sNext:"Siguiente",sPrevious:"Previo"},sEmptyTable:"Ningún dato disponible en esta tabla",sInfo:"Mostrando registros del _START_ al _END_ de un total de _TOTAL_ registros",sInfoEmpty:"Mostrando de 0 hasta 0 de 0 registros",sInfoFiltered:"(filtrado de un total de _MAX_ registros)",sInfoPostFix:"",sDecimal:"",sThousands:",",sLengthMenu:"Mostrar _MENU_ registros",sLoadingRecords:"<span class='table_loader'><i id='table_loader' class='fa fa-spinner fa-spin fa-3x fa-fw'></i><br> Cargando...</span>",sProcessing:"<span class='table_loader'><i id='table_loader' class='fa fa-spinner fa-spin fa-3x fa-fw'></i><br> Cargando...</span>",sSearch:"Buscar:",sSearchPlaceholder:"",sUrl:"",sZeroRecords:"No se encontraron resultados"},

CREATE DATABASE siame DEFAULT CHARACTER SET utf8 COLLATE utf8_spanish2_ci;
...
)ENGINE=MYISAM CHARSET utf8 COLLATE utf8_spanish2_ci;
-- modulo
CREATE TABLE tabla(
id TINYINT(3) UNSIGNED PRIMARY KEY AUTO_INCREMENT,
...
)ENGINE = MYISAM DEFAULT CHARACTER SET = utf8 COLLATE = utf8_spanish2_ci; 
...
-- profesor_concurso
CREATE TABLE profesor_concurso(
id INT(11) UNSIGNED PRIMARY KEY AUTO_INCREMENT,
profesor_id INT(11) UNSIGNED NOT NULL,
concurso_id INT(11) UNSIGNED NOT NULL,
condicion_ingreso ENUM('TITULAR','SUPLENTE') NOT NULL DEFAULT 'TITULAR',
condicion_profesor_saliente ENUM('JUBILACION','BAJA','LICENCIA','VACACIONES') NOT NULL DEFAULT 'BAJA',
puntaje FLOAT(5,2) UNSIGNED NOT NULL,
cargo_tomado BOOLEAN NOT NULL DEFAULT TRUE,
fecha_alta TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP,
operador_alta INT(11) UNSIGNED NOT NULL,
fecha_modificacion TIMESTAMP,
operador_modificacion INT(11) UNSIGNED,
baja BOOL NOT NULL DEFAULT FALSE,
UNIQUE INDEX `prco_unique` (profesor_id,concurso_id,baja),
CONSTRAINT `fk_prco_prof` FOREIGN KEY (`profesor_id`) REFERENCES `profesor`(`legajo`) ON UPDATE CASCADE ON DELETE RESTRICT,
CONSTRAINT `fk_prco_conc` FOREIGN KEY (`concurso_id`) REFERENCES `concurso`(`id`) ON UPDATE CASCADE ON DELETE RESTRICT,
